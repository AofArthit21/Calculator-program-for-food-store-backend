...
//   // สามารถใช้ Dependency Injection สำหรับ Strategy ได้ถ้า Logic ซับซ้อนกว่านี้
//   private strategies = [
...
//     // 2. Map Cart Items
//     const cartItems: CartItem[] = dto.items.map(item => {
...
//     let totalPrice = cartItems.reduce((sum, item) => sum + (Number(item.product.price) * item.quantity), 0);
//     const subTotal = totalPrice;

//     // 4. Apply Strategies
//     // Strategy 1: Bulk Discount (ลดจากราคาสินค้า)
//     const bulkStrategy = new BulkDiscountStrategy();
//     const bulkDiscount = bulkStrategy.calculate(cartItems, dto.isMember, totalPrice);
//     totalPrice -= bulkDiscount;

//     // Strategy 2: Member Discount (ลดจากยอดคงเหลือ)
//     const memberStrategy = new MemberDiscountStrategy();
//     const memberDiscount = memberStrategy.calculate(cartItems, dto.isMember, totalPrice);
